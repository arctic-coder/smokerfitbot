...
START_MESSAGE = (
    ...
    "Держите <a href=\"https://telegra.ph/Pamyatka-ot-Fizkultury-kurilshchika-09-13\">памятку</a>. Если вы генерируете тренировку впервые, обязательно прочтите ее, прежде чем начинать, - там написано, что вообще с этой тренировкой делать и как не перестараться.\n\n"
    "<b>Ну и поехали!</b>"
)
...
# --- ПОДПИСКА / ПЛАТЕЖИ ---
SUB_REQUIRED = "Бесплатная тренировка уже использована.\nОформите подписку, чтобы продолжить."
SUB_ALREADY_ACTIVE = (
...
CANCEL_NEW_AFTER = "Текущий платёж отменён. Создан новый:"
