...
START_MESSAGE = (
    ...
    "Держите памятку. Если вы генерируете тренировку впервые, обязательно прочтите ее, прежде чем начинать, - там написано, что вообще с этой тренировкой делать и как не перестараться.\n\n"
    "<b>Ну и поехали!</b>"
)
